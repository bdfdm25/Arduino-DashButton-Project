<?php
  ...
  $sql = "SELECT * FROM carrinho WHERE id_produto = '$id_produto' AND id_comprador = '$id_comprador'";
  ...
  if($produto_existe){
    ...
    $sql = "INSERT INTO carrinho(id_produto, quantidade, id_comprador) VALUES ('$id_produto', '$quantidade', '$id_comprador') ";
    if(mysqli_query($link, $sql)){
      header("Location: meu_carrinho.php");
    }
  }
